...
router.get('/newsletters', authenticateAdmin, adminController.newslettersPage);
router.get('/badges', authenticateAdmin, adminController.badgesPage);
router.get('/sponsors', authenticateAdmin, adminController.sponsorsPage);
router.get('/stands', authenticateAdmin, adminController.standsPage);
router.get('/exports', authenticateAdmin, adminController.exportsPage);
router.get('/settings', authenticateAdmin, adminController.settingsPage);

// API pour les participants
router.get('/api/participants', authenticateAdmin, adminController.getParticipants);
router.post('/api/participants', authenticateAdmin, adminController.createParticipant);
router.put('/api/participants/:id', authenticateAdmin, adminController.updateParticipant);
router.put('/api/participants/:id/status', authenticateAdmin, adminController.updateParticipantStatus);
router.delete('/api/participants/:id', authenticateAdmin, adminController.deleteParticipant);
router.post('/api/participants/clear-all', authenticateAdmin, adminController.clearAllParticipants);

// API pour les invitations
router.post('/api/invitations/send', authenticateAdmin, adminController.sendInvitation);
router.post('/api/invitations/bulk', authenticateAdmin, adminController.sendBulkInvitations);

// API pour l'export
router.get('/api/participants/export', authenticateAdmin, adminController.exportParticipants);
